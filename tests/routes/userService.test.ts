import UserService from "../../src/routes/userService";
...
describe("Testing login", () => {
  ...
  it("should check login data with database and then pass session details to the controller", async () => {
    ...
    const mSVC = new UserService(mKnex as any, mCheckPassword);
  ...
  it("should check whether the username exists", async () => {
    ...
    const mSVC = new UserService(nKnex as any, mCheckPassword);
